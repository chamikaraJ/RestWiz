...
public interface AllergiesService {
    ...
    /*
     * Returns the associated ptAllergiesForObsptid for given Allergies id.
     *
     * @param allergyId value of allergyId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<PtAllergy> findAssociatedPtAllergiesForObsptid(Integer allergyId, Pageable pageable);

    /*
     * Returns the associated ptAllergiesForFkAllergy for given Allergies id.
     *
     * @param allergyId value of allergyId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated PtAllergy instances.
     ...
     * @see Page
     */
    Page<PtAllergy> findAssociatedPtAllergiesForFkAllergy(Integer allergyId, Pageable pageable);
