 ...
 * @see Events
 */
@Service("clinicalobs.EventsService")
@Validated
public class EventsServiceImpl implements EventsService {
    ...
    @Autowired
    @Qualifier("clinicalobs.EventsDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service clinicalobs for table Events to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service clinicalobs for table Events to {} format", options.getExportType());
