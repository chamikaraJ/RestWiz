...
import com.restwiz.clinicalobs.service.AllergiesService;
...
public class AllergiesController {
    ...
    public Allergies editAllergies(@PathVariable("id") Integer id, @RequestBody Allergies allergies) {
        LOGGER.debug("Editing Allergies with id: {}" , allergies.getAllergyId());

        allergies.setAllergyId(id);
    ...
    @RequestMapping(value="/{id:.+}/ptAllergiesForObsptid", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the ptAllergiesForObsptid instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<PtAllergy> findAssociatedPtAllergiesForObsptid(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated ptAllergiesForObsptid");
        return allergiesService.findAssociatedPtAllergiesForObsptid(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/ptAllergiesForFkAllergy", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the ptAllergiesForFkAllergy instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<PtAllergy> findAssociatedPtAllergiesForFkAllergy(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated ptAllergiesForFkAllergy");
        return allergiesService.findAssociatedPtAllergiesForFkAllergy(id, pageable);
    }
