...
import com.restwiz.clinicalobs.service.UserService;
 ...
 * @see User
 */
@RestController("clinicalobs.UserController")
@Api(value = "UserController", description = "Exposes APIs to work with User resource.")
@RequestMapping("/clinicalobs/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

    @Autowired
	@Qualifier("clinicalobs.UserService")
