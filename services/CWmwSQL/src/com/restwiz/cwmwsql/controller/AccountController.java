...
public class AccountController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Account editAccount(@PathVariable("id") String id, @RequestBody Account account) {
        LOGGER.debug("Editing Account with id: {}" , account.getAccountno());
