...
public class CWmwSQLQueryExecutorServiceImpl implements CWmwSQLQueryExecutorService {
    ...
    @Transactional(value = "CWmwSQLTransactionManager", readOnly = true)
    @Override
    public Page<QryGetAllHealthFundsResponse> executeQryGetAllHealthFunds(Pageable pageable) {
        Map<String, Object> params = new HashMap<>(0);


        return queryExecutor.executeNamedQuery("qryGetAllHealthFunds", params, QryGetAllHealthFundsResponse.class, pageable);
    }

    @Transactional(value = "CWmwSQLTransactionManager", timeout = 300, readOnly = true)
    @Override
    public void exportQryGetAllHealthFunds(ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        Map<String, Object> params = new HashMap<>(0);


        QueryProcedureInput queryInput = new QueryProcedureInput("qryGetAllHealthFunds", params, QryGetAllHealthFundsResponse.class);
    ...
    public Integer executeQryInsertAppointment(QryInsertAppointmentRequest qryInsertAppointmentRequest) {
        ...
        params.put("cal_type", qryInsertAppointmentRequest.getCalType());
    ...
    @Transactional(value = "CWmwSQLTransactionManager", readOnly = true)
    @Override
    public Page<QryUnreadSmsAndAppointmentCountResponse> executeQryUnreadSmsAndAppointmentCount(String patientno, Pageable pageable) {
        Map<String, Object> params = new HashMap<>(1);

        params.put("patientno", patientno);

        return queryExecutor.executeNamedQuery("qryUnreadSmsAndAppointmentCount", params, QryUnreadSmsAndAppointmentCountResponse.class, pageable);
    }

    @Transactional(value = "CWmwSQLTransactionManager", timeout = 300, readOnly = true)
    @Override
    public void exportQryUnreadSmsAndAppointmentCount(String patientno, ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        Map<String, Object> params = new HashMap<>(1);

        params.put("patientno", patientno);

        QueryProcedureInput queryInput = new QueryProcedureInput("qryUnreadSmsAndAppointmentCount", params, QryUnreadSmsAndAppointmentCountResponse.class);
    ...
    @Transactional(value = "CWmwSQLTransactionManager", readOnly = true)
    @Override
    public Page<QryGetAllAppointmentByPatientNoResponse> executeQryGetAllAppointmentByPatientNo(String patientno, Pageable pageable) {
        Map<String, Object> params = new HashMap<>(1);

        params.put("patientno", patientno);

        return queryExecutor.executeNamedQuery("qryGetAllAppointmentByPatientNo", params, QryGetAllAppointmentByPatientNoResponse.class, pageable);
    }

    @Transactional(value = "CWmwSQLTransactionManager", timeout = 300, readOnly = true)
    @Override
    public void exportQryGetAllAppointmentByPatientNo(String patientno, ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        Map<String, Object> params = new HashMap<>(1);

        params.put("patientno", patientno);

        QueryProcedureInput queryInput = new QueryProcedureInput("qryGetAllAppointmentByPatientNo", params, QryGetAllAppointmentByPatientNoResponse.class);
    ...
    @Transactional(value = "CWmwSQLTransactionManager", readOnly = true)
    @Override
    public Page<QryGetPatientByUnameResponse> executeQryGetPatientByUname(String tusername, Pageable pageable) {
        Map<String, Object> params = new HashMap<>(1);

        params.put("t_username", tusername);

        return queryExecutor.executeNamedQuery("QryGetPatientByUname", params, QryGetPatientByUnameResponse.class, pageable);
    }

    @Transactional(value = "CWmwSQLTransactionManager", timeout = 300, readOnly = true)
    @Override
    public void exportQryGetPatientByUname(String tusername, ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        Map<String, Object> params = new HashMap<>(1);

        params.put("t_username", tusername);

        QueryProcedureInput queryInput = new QueryProcedureInput("QryGetPatientByUname", params, QryGetPatientByUnameResponse.class);
    ...
    @Transactional(value = "CWmwSQLTransactionManager")
    @Override
    public Integer executeQryUpdatePatientPassword(QryUpdatePatientPasswordRequest qryUpdatePatientPasswordRequest) {
        Map<String, Object> params = new HashMap<>(2);

        params.put("pass", qryUpdatePatientPasswordRequest.getPass());
        params.put("patientno", qryUpdatePatientPasswordRequest.getPatientno());

        return queryExecutor.executeNamedQueryForUpdate("qryUpdatePatientPassword", params);
    }
    ...
    @Transactional(value = "CWmwSQLTransactionManager", readOnly = true)
    @Override
    public Page<QryGetAllEducationMaterialsResponse> executeQryGetAllEducationMaterials(Pageable pageable) {
        Map<String, Object> params = new HashMap<>(0);


        return queryExecutor.executeNamedQuery("qryGetAllEducationMaterials", params, QryGetAllEducationMaterialsResponse.class, pageable);
    }

    @Transactional(value = "CWmwSQLTransactionManager", timeout = 300, readOnly = true)
    @Override
    public void exportQryGetAllEducationMaterials(ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        Map<String, Object> params = new HashMap<>(0);


        QueryProcedureInput queryInput = new QueryProcedureInput("qryGetAllEducationMaterials", params, QryGetAllEducationMaterialsResponse.class);
